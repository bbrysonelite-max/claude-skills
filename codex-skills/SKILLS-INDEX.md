...
Audited & verified: 2026-08-28. Count: 183 skill folders / 180 named skills on the live shelf.
...
- **mine** — run the agnostic Data Mine against a vertical (raw ore).
- **refine** — refine mine ore into resolved, contactable individual leads.
- **signal-mine** — map demand/fear/confusion/intent before people become leads.
...
- **tiger-leader-hunt** — weekly discovery of network-marketing leaders for partnerships.
- **whitelabel-radar** — trend pulse → segmented white-label target list.
...
---
*Removed this audit (no longer installed anywhere): ai-evaluation-audit, assumptions-audit, codebase-pattern-mapping, documentation-claim-verification, integration-flow-audit, maigret-username-enrichment, requirements-coverage-audit, social-signal-ledger, threat-mitigation-audit. Superpowers process skills moved to the plugin (see header).*
