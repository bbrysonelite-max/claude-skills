...
The direct main-agent workflow is always valid. Delegate only when the active environment permits it, and never require delegation to proceed.

Never expose or print secret, credential, or token values.

Mandatory dependencies:
- `agent-reach CLI and platform backends`
